...
이메일로 발송됩니다.`;
    ...
    try {
        ...
        const docRef = await attendanceRecordsCollection.add(attendanceData);
        ...
        try {
            ...
            const emailResponse = await fetch('https://asia-northeast3-attendance-records-375b6.cloudfunctions.net/sendAttendanceEmail', {
                method: 'POST',
                headers: {
        ...
        await attendanceRecordsCollection.doc(docRef.id).update({
            emailSent: emailSent,
